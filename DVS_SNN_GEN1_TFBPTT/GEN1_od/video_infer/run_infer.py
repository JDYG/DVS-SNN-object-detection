...
parser.add_argument('--config', type=str, default='config_yoloCS3_64attn_20e3_hard.py', help='Config file')
# parser.add_argument('--config', type=str, default='config_yoloCS3_64attn_20e3_hard_LIF_infer.py', help='Config file')
# parser.add_argument('--config', type=str, default='config_yolox_64attn_20e3_hard.py', help='Config file')
...
# from GEN1_od.video_infer.module_infer_plot_video_paper_from_moving_static_moving import Gen1DetectionModule
...
class Gen1DataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        if stage == 'validate':
            ...
            test_evt_lst = '/Gen1_Automotive/test/17-04-12_19-21-02_427500000_487500000_td.dat'
            test_lbl_lst = None
            ...
            # self.validataion_dataset = Subset(self.validataion_dataset, [26])
...
def main():
    ...
    config_module.pretrained_model = 'model.ckpt'
